...
> update the readme to mention the new configuration section in settings and link to yt-dlp configuration options

**Changes Made:**

- Added new "yt-dlp Configuration" section to README.md documenting:
  - How to access the Configuration section in Settings
  - Example configurations (rate limiting, format selection, proxy, multiple arguments)
  - Link to official yt-dlp documentation
