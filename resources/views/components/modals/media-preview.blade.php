            ...
            <div class="flex items-center justify-center">
                ...
                <template x-if="isVideo">
                    <div class="w-full flex items-center justify-center" wire:ignore>
                        {{-- Stock Vidstack layout; the .mgd-player padding override
                             (resources/css/vidstack-custom.css) drops the control bar
                             into a black band below the video so burned-in captions
                             stay visible. --}}
                        <media-player
                            x-ref="videoPlayer"
                            :src="mediaUrl"
